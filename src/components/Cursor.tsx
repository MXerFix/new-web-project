...
export const Cursor = ({ cursorRef }: { cursorRef: any[] }) => {
  ...
  const cursorSizeX = isHovered ? rect?.width * 0.9 : 16
  const cursorSizeY = isHovered ? rect?.height * 0.8 : 16
  ...
  }, [isHovered, cursorSizeX, cursorSizeY, currentRef])
